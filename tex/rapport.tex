...
\paragraph{toto}{Nous utilisons deux parseurs pour notre projet, un utilisant la grammaire \textbf{C-11} donnée dans le sujet, et le second une grammaire LaTeX que nous avons écrite.
