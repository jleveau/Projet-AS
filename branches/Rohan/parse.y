...
%type<nom>type_specifier atomic_type_specifier struct_or_union_specifier enum_specifier type_qualifier selection_statement
...
selection_statement
: IF '(' expression ')' statement ELSE statement {print_balise_span("type_specifier",$1);}
