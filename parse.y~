...
direct_declarator
	...
	| direct_declarator '(' ')'
	| direct_declarator '(' {/*cree nouvelle liste pour passer en parametre à tmp=new_block list l=list_create();*/} identifier_list {}')'
	;
...
compound_statement
	: '{' {tmp=new_block(list_create());}  {fin_block("block0");/*"block0 car tmp fait bugguer; à régler*/} '}'
	| '{' {tmp=new_block(list_create());}  block_item_list '}' {fin_block("block0");}
	;
